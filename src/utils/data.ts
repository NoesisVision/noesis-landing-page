...
const useCases = [
    {
        title: "Noesis UI",
        description: "An intuitive web interface that provides developers and non-technical stakeholders with immediate access to system knowledge. The UI offers interactive visualizations, real-time system insights, and collaborative features that make complex system architecture accessible to everyone involved in the project.",
